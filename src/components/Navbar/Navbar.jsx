...
const Navbar = () => {
  ...
  return (
    ...
    <div className=" pl-7 md:pl-16 text-4xl  h-16 pt-[4px]" ><img src={logo} className='overflow-hidden md:h-14 h-10'/></div>
    ...
    absolute bg-slate-900 md:bg-transparent text-white right-0 pl-9 py-6 md:py-0 z-[-1] top-14 w-[200px] transition-all duration-500 ease-linear ${open ?'right-0 opacity-100':' opacity-0'} md:opacity-100`}>
      ...
      <li onClick={()=>handleScroll('skill')} className="cursor-pointer hover:text-yellow-300 font-semibold  md:text-base mb-5 md:mb-0 text-xl">Skills</li>
      <li onClick={()=>handleScroll('project')} className="cursor-pointer hover:text-yellow-300 font-semibold md:text-base md:mb-0 mb-5 text-xl">Projects</li>
